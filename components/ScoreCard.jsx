...
// // Full recruiter report — scores, verdict, evidence, feedback
//
...
//     Reject: 'rgba(239,68,68,0.08)',
//   }[verdict] || 'rgba(0,0,0,0.04)';
//
//   const verdictBorder = {
//     Pass:   'rgba(34,197,94,0.25)',
//     Hold:   'rgba(245,158,11,0.25)',
//     Reject: 'rgba(239,68,68,0.25)',
//   }[verdict] || 'rgba(0,0,0,0.1)';
//
//   const DIMENSIONS = [
...
//           <p style={styles.meta}>{subject} · Screened {new Date().toLocaleDateString()}</p>
//         </div>
//         <div style={{ ...styles.verdictBadge, background: verdictBg, color: verdictColor, border: `1px solid ${verdictBorder}` }}>
//           {verdict}
//         </div>
//       </div>
//
...
//                 </div>
//                 {d.evidence && (
//                   <p style={styles.evidence}>"{d.evidence}"</p>
//                 )}
//               </div>
//             );
//           })}
...
//
//       {/* Divider */}
//       {feedback?.length > 0 && <div style={styles.divider} />}
//
//       {/* Feedback */}
//       {feedback?.length > 0 && (
//         <div style={styles.section}>
